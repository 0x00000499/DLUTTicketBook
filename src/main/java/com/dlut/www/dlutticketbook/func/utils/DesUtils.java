 ...
 */
package com.dlut.www.dlutticketbook.func.utils;
...
public class DesUtils {
    ...
    public static String encode(String data, String firstKey, String secondKey, String thirdKey){
        return desCore.strEnc(data, firstKey, secondKey, thirdKey);
    }
    public static String decode(String data, String firstKey, String secondKey, String thridKey){
        return desCore.strDec(data, firstKey, secondKey, thridKey);
    }
